...
const COMMON_SPECIFICATIONS = {
  ...
  electronics: {
    ...
    'Экран': [
      'Диагональ экрана', 'Разрешение экрана', 'Тип матрицы', 'Частота обновления', 'Яркость', 'Покрытие экрана'
    ],
    'Процессор': [
      'Модель процессора', 'Количество ядер', 'Частота процессора', 'Кэш-память'
    ],
    'Память': [
      'Оперативная память (RAM)', 'Тип памяти', 'Встроенная память', 'Поддержка карт памяти'
    ],
    'Камера': [
      'Основная камера', 'Фронтальная камера', 'Вспышка', 'Запись видео', 'Стабилизация'
    ],
    'Аккумулятор': [
      'Емкость аккумулятора', 'Тип аккумулятора', 'Быстрая зарядка', 'Беспроводная зарядка', 'Время работы'
    ],
    'Связь и коммуникации': [
      'Wi-Fi', 'Bluetooth', 'GPS', 'NFC', 'Мобильная сеть'
    ],
    'Размеры и вес': [
  ...
  fashion: {
    'Основные характеристики': [
      'Бренд', 'Артикул', 'Страна производства', 'Сезон', 'Пол'
    ],
    'Размеры': [
      'Размер', 'Размер на этикетке', 'Международный размер', 'Длина', 'Ширина', 'Обхват груди', 'Обхват талии', 'Обхват бедер'
    ],
    'Материалы': [
      'Материал', 'Состав', 'Материал подкладки', 'Материал утеплителя'
    ],
    'Особенности': [
      'Цвет', 'Рисунок', 'Стиль', 'Застежка', 'Карманы', 'Капюшон'
    ],
    'Уход': [
      'Температура стирки', 'Химчистка', 'Глажка', 'Отбеливание'
    ]
  },
